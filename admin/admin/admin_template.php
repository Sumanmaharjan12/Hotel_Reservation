...
<body>
    ...
    <div class="dashboard"> <!-- dashboard begins ------------------------------------------------------------------->
        ...
        <section id="sidebar">
            <div class="icon1">
                <a href="admin_index.php"><img src="upload/id_card/logo.png" alt="Logo1">
                </a>
            </div>
            ...
            <ul class="side-menu">
                <li>
                    <a href="checkout.php"> <!-- Link to checkout history page -->
                        <i class='bx bx-history'></i>
                        <span class="text">Checkout History</span>
                    </a>
                </li>
                <li>
